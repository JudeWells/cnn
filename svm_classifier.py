...
"""
Created by Jude Wells 23-09-06
evaluating the potential of ML classifiers
to distinguish between fire and false alarms
using normalised spectra as features
"""
...
def evaluate_classifier_loo(preprocessed_data):
    """
    Evaluate the classifier using leave-one-out cross validation
    one experiment is left out as test set
    """
    outdir = 'out/classifier_results'
